...
mustInclude('<div class="pmm-wb-header-left${sideName === \'top\' ? \' header-left\' : \'\'}">', '世界书标题栏缺少区分上下卡片的左侧名称区域');
...
mustInclude('.pmm-wb-header-left>.pmm-wb-title-row,.pmm-wb-header-left>.pmm-wb-title-card,.pmm-wb-title-card>.pmm-wb-title-row{width:100%;min-width:0;flex:1 1 auto}', '世界书名称行或上方标题外框没有填满左侧区域');
