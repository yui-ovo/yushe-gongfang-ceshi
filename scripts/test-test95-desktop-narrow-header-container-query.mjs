...
for(const marker of ['@media (hover: hover) and (pointer: fine)',':not(.pmm-mobile-layout-enabled)','overflow-x: auto !important','flex-wrap: nowrap !important','flex-shrink: 0 !important','scrollbar-width: thin !important'])assert.ok(css.includes(marker),marker);
