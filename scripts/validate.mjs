...
const workshop = await readFile(new URL('../dist/workshop-v3.20.js', import.meta.url), 'utf8');
...
if (!entry.includes('workshop-v3.20.js') || !entry.includes('worldbook-stitch-test3.js') || !entry.includes("const EXTENSION_VERSION = '3.20.0-test.118'")) {
