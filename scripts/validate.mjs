...
if (!entry.includes('workshop-v2.95.js') || !entry.includes('worldbook-stitch-test3.js') || !entry.includes("const EXTENSION_VERSION = '2.95.0-test.89'")) {
  throw new Error('扩展启动器没有指向 v2.95');
}
