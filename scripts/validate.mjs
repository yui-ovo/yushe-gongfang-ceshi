...
const workshop = await readFile(new URL('../dist/workshop-v3.15.js', import.meta.url), 'utf8');
...
if (!entry.includes('workshop-v3.15.js') || !entry.includes('worldbook-stitch-test3.js') || !entry.includes("const EXTENSION_VERSION = '3.15.0-test.113'")) {
