...
assert.ok(!style.includes('.${CAPTURE_TITLE_CLASS} .title-row'), '录制状态仍因放大按钮额外挤压预设名称');
assert.ok(!style.includes('var(--pmm-title-overflow-actions-width) - 34px'), '录制状态仍保留旧的大按钮让位宽度');
