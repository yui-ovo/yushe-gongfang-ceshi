...
.pmm-wb-multi-drag-float{position:fixed;z-index:2147483647;left:12px;top:12px;width:174px;height:58px;font-family:inherit;line-height:1;pointer-events:none}.pmm-wb-multi-drag-float-back{position:absolute;left:9px;top:8px;width:164px;height:50px;border-radius:17px;background:#d8d5db;box-shadow:0 10px 22px rgba(0,0,0,.24)}.pmm-wb-multi-drag-float-face{position:absolute;left:0;top:0;width:164px;height:50px;box-sizing:border-box;padding:0 10px;display:flex;align-items:center;gap:9px;border:1px solid rgba(255,255,255,.86);border-radius:17px;background:#efedf0;color:#504e55!important;-webkit-text-fill-color:#504e55!important;box-shadow:0 5px 14px rgba(0,0,0,.18);font-size:12px;font-weight:680;letter-spacing:.01em;white-space:nowrap}.pmm-wb-multi-drag-float-face i{width:13px;color:#9a979e!important;-webkit-text-fill-color:#9a979e!important;font-size:13px;text-align:center}.pmm-wb-multi-drag-float-face span{min-width:0;flex:1;white-space:nowrap}.pmm-wb-multi-drag-float-face b{width:28px;height:28px;display:flex;align-items:center;justify-content:center;border-radius:50%;background:#dfdce2;color:#626068!important;-webkit-text-fill-color:#626068!important;font-size:11px;font-weight:650}
