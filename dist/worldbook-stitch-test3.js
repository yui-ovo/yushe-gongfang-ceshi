      ...
      <div class="pmm-wb-main-content">
        <header class="pmm-wb-header">
          ...
          <div class="pmm-wb-header-right">
            ...
            ${toolbarButton('batch-delete', '删除所选', 'fa-trash', `data-wb-side="${sideName}" ${side.multi ? (side.selected.size ? '' : 'disabled') : 'disabled aria-hidden="true" tabindex="-1" data-pmm-wb-tool-reserved'}`)}
