...
(() => {
  ...
  function positionWorldMultiDragFloat(event) {
    ...
    worldMultiDragFloat.style.left = `${Math.max(8, Math.min(left >= 8 ? left : alternateLeft, Math.max(8, width - rect.width - 8)))}px`;
    worldMultiDragFloat.style.top = `${Math.max(8, Math.min(y - rect.height + 14, Math.max(8, height - rect.height - 8)))}px`;
  }
...
.pmm-wb-multi-drag-float{position:fixed;z-index:2147483647;left:12px;top:12px;width:198px;height:65px;font-family:inherit;line-height:1;pointer-events:none}.pmm-wb-multi-drag-float-back{position:absolute;left:9px;top:9px;width:188px;height:56px;box-sizing:border-box;border:1px solid rgba(255,255,255,.68);border-radius:20px;background:rgba(220,218,224,.64);box-shadow:0 12px 24px rgba(62,58,68,.13),0 2px 5px rgba(62,58,68,.07);-webkit-backdrop-filter:blur(18px) saturate(112%);backdrop-filter:blur(18px) saturate(112%)}.pmm-wb-multi-drag-float-face{position:absolute;left:0;top:0;width:188px;height:56px;box-sizing:border-box;padding:0 14px;display:flex;align-items:center;gap:12px;border:1px solid rgba(255,255,255,.94);border-radius:20px;background:rgba(247,246,248,.88);color:#696770!important;-webkit-text-fill-color:#696770!important;box-shadow:0 12px 24px rgba(62,58,68,.13),0 2px 5px rgba(62,58,68,.07),inset 0 1px 0 rgba(255,255,255,.52);-webkit-backdrop-filter:blur(18px) saturate(112%);backdrop-filter:blur(18px) saturate(112%);font-size:16px;font-weight:520;letter-spacing:.01em;white-space:nowrap}.pmm-wb-multi-drag-float-face i{width:18px;color:#aaa7b0!important;-webkit-text-fill-color:#aaa7b0!important;font-size:18px;text-align:center}.pmm-wb-multi-drag-float-face span{min-width:0;flex:1;white-space:nowrap;color:inherit!important;-webkit-text-fill-color:currentColor!important}.pmm-wb-multi-drag-float-face b{width:36px;height:36px;display:flex;align-items:center;justify-content:center;border-radius:50%;background:rgba(225,224,229,.88);color:#85828d!important;-webkit-text-fill-color:#85828d!important;font-size:14px;font-weight:520}.pmm-wb-multi-drag-float[data-pmm-wb-multi-drag-tone="dark"] .pmm-wb-multi-drag-float-back{border-color:rgba(205,214,231,.32);background:rgba(69,80,101,.58);box-shadow:0 16px 30px rgba(0,0,0,.40),0 3px 7px rgba(0,0,0,.22)}.pmm-wb-multi-drag-float[data-pmm-wb-multi-drag-tone="dark"] .pmm-wb-multi-drag-float-face{border-color:rgba(205,214,231,.32);background:rgba(36,43,57,.84);color:#f3f4f8!important;-webkit-text-fill-color:#f3f4f8!important;box-shadow:0 16px 30px rgba(0,0,0,.40),0 3px 7px rgba(0,0,0,.22),inset 0 1px 0 rgba(255,255,255,.10)}.pmm-wb-multi-drag-float[data-pmm-wb-multi-drag-tone="dark"] .pmm-wb-multi-drag-float-face i{color:#dce1ea!important;-webkit-text-fill-color:#dce1ea!important}.pmm-wb-multi-drag-float[data-pmm-wb-multi-drag-tone="dark"] .pmm-wb-multi-drag-float-face b{background:rgba(78,89,112,.72);color:#bfc7d6!important;-webkit-text-fill-color:#bfc7d6!important}
