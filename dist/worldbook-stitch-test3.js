...
(() => {
  ...
  function showWorldMultiDragFloat(event, count) {
    ...
    image.style.cssText = `position:fixed;left:0;top:0;width:1px;height:1px;opacity:.01;background:${chip.style.getPropertyValue('--pmm-wb-drag-bg')};pointer-events:none;`;
...
.pmm-wb-multi-drag-float{position:fixed;z-index:2147483647;left:12px;top:12px;width:174px;height:58px;font-family:inherit;line-height:1;pointer-events:none}.pmm-wb-multi-drag-float-back{position:absolute;left:9px;top:8px;width:164px;height:50px;border-radius:17px;background:color-mix(in srgb,var(--pmm-wb-drag-bg,rgba(255,255,255,.96)) 84%,var(--pmm-wb-drag-text,#1f2937) 16%);box-shadow:0 10px 22px rgba(0,0,0,.14)}.pmm-wb-multi-drag-float-face{position:absolute;left:0;top:0;width:164px;height:50px;box-sizing:border-box;padding:0 10px;display:flex;align-items:center;gap:9px;border:1px solid color-mix(in srgb,var(--pmm-wb-drag-text,#1f2937) 8%,transparent);border-radius:17px;background:var(--pmm-wb-drag-bg,rgba(255,255,255,.96));color:var(--pmm-wb-drag-text,#1f2937);-webkit-text-fill-color:currentColor;box-shadow:0 5px 14px rgba(0,0,0,.13);font-size:12px;font-weight:680;letter-spacing:.01em;white-space:nowrap}.pmm-wb-multi-drag-float-face i{width:13px;color:color-mix(in srgb,var(--pmm-wb-drag-text,#1f2937) 48%,transparent);-webkit-text-fill-color:color-mix(in srgb,var(--pmm-wb-drag-text,#1f2937) 48%,transparent);font-size:13px;text-align:center}.pmm-wb-multi-drag-float-face span{min-width:0;flex:1;white-space:nowrap}.pmm-wb-multi-drag-float-face b{width:28px;height:28px;display:flex;align-items:center;justify-content:center;border-radius:50%;background:color-mix(in srgb,var(--pmm-wb-drag-text,#1f2937) 7%,var(--pmm-wb-drag-bg,rgba(255,255,255,.96)));color:color-mix(in srgb,var(--pmm-wb-drag-text,#1f2937) 72%,transparent);-webkit-text-fill-color:color-mix(in srgb,var(--pmm-wb-drag-text,#1f2937) 72%,transparent);font-size:11px;font-weight:650}
